    ...
    <div>
      <div className="disclaimer-content">
        <p>
          ...
          rohitsharma2k3@gmail.com.
        </p>

        <h2 style={{ textAlign: "left", margin: "0px" }}>
          Disclaimers for Question Paper Library
        </h2>

        <p>
          All the information on this website -{" "}
          <a href="https://github.com/rohit2k3">Question Paper Library</a> - is
          published in good faith and for general information purpose only.
          Question Paper Library does not make any warranties about the
          completeness, reliability and accuracy of this information. Any action
          you take upon the information you find on this website (Question Paper
          Library), is strictly at your own risk. Question Paper Library will
        ...
        <h2 style={{ textAlign: "left", margin: "0px" }}>Consent</h2>
        ...
        <h2 style={{ textAlign: "left", margin: "0px" }}>Update</h2>
        ...
        <p>
          ...
          rohitsharma2k3@gmail.com also, you can contact us by our contact us
          form.Go to homepage {`-->`}
          <a href="https://github.com/rohit2k3">Question Paper Library</a>
        </p>
        <p>
          <center>"Thanks for visiting our Disclaimer Page"</center>
        </p>
      </div>
    </div>
  );
